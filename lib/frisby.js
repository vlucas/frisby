...
Frisby.prototype.expectJSONLength = function(expectedLength) {
  ...
  this.current.expects.push(function() {
    ...
    var expectLength = function(jsonBody, expectedLength) {
      var len = 0;
    ...
    if("*" === type) {
      _.each(jsonBody, function(json) {
        expectLength(json, expectedLength);
      });
    } else {
      expectLength(jsonBody, expectedLength);
    }
...
jasmine.Matchers.prototype.toContainJson = function(expected) {
  this.message = function() {
...
jasmine.Matchers.prototype.toContainJsonTypes = function(expected) {
  this.message = function() {
