...
// Callback function to run after the test is completed
// Helper to also convert response headers to JSON
Frisby.prototype.afterResponseHeaders = function(cb) {
    var self = this;
    this.current.after.push(function() {
...
// Callback function to run after the test is completed
// Helper to also convert response body and response headers to JSON
Frisby.prototype.afterJSONWithResponseHeaders = function(cb) {
    var self = this;
    this.current.after.push(function() {
        var responseHeaders = _jsonParse(self.current.response.headers);
        var bodyJSON = _jsonParse(self.current.response.body);
